...
import mota_apps.users.managers
import mota_apps.users.models
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_visitor', models.BooleanField(default=False, help_text="Designates for only views the data but can't edit that is all input are disable in the admin site", verbose_name='is visitor')),
                ('is_client', models.BooleanField(default=False, help_text='User is a client.', verbose_name='is client')),
            ...
            managers=[
                ('objects', mota_apps.users.managers.UserManager()),
            ],
        ),
        migrations.CreateModel(
            name='Partners',
            fields=[
                ...
                ('logo', models.ImageField(blank=True, help_text="Partner's logo image.", max_length=1000, null=True, upload_to=mota_apps.users.models.partner_logo_path, verbose_name='Logo')),
